...
final class SettingsTableView: UITableView {
    ...
    private var data: [SettingsTableViewModel] = [
        .init(image: Images.SettingsImages.profile, title: "Profile"),
        .init(image: Images.SettingsImages.conversations, title: "Conversations"),
        .init(image: Images.SettingsImages.project, title: "Projects"),
        .init(image: Images.SettingsImages.policies, title: "Terms and Policies")
    ]
